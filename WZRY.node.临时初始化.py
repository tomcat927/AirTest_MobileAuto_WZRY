...
#self.房间元素.append(Template(r"tpl1707363856706.png", record_pos=(0.355, 0.233), resolution=(960, 540)))
#self.房间元素.append(Template(r"tpl1707363869628.png", record_pos=(0.356, -0.258), resolution=(960, 540)))
#self.房间元素.append(Template(r"tpl1707363921186.png", record_pos=(0.355, -0.26), resolution=(960, 540)))
#self.房间元素.append(Template(r"tpl1707363931121.png", record_pos=(0.406, 0.232), resolution=(960, 540)))